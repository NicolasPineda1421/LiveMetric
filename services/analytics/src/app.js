...
app.get(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error('Error en /api/elections/:id/metrics/timeseries:', err.message);
      return res.status(500).json({ error: 'Error interno del servidor' });
    }
  }
);
...
app.get(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error('Error en /api/elections/:id/metrics/participation:', err.message);
      return res.status(500).json({ error: 'Error interno del servidor' });
    }
  }
);
...
app.get(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error('Error en /api/elections/:id/metrics/operational:', err.message);
      return res.status(500).json({ error: 'Error interno del servidor' });
    }
  }
);
...
app.get(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error('Error en /api/elections/:id/metrics/audit:', err.message);
      return res.status(500).json({ error: 'Error interno del servidor' });
    }
  }
);
...
app.get(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error('Error en GET /api/elections/:id/dashboards:', err.message);
      return res.status(500).json({ error: 'Error interno del servidor' });
    }
  }
);
...
app.post(
  ...
  async (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      return res.status(400).json({ error: 'Datos de tablero inválidos' });
    }
...
app.get(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error('Error en GET /api/dashboards/:dashboardId:', err.message);
      return res.status(500).json({ error: 'Error interno del servidor' });
    }
  }
);
...
app.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error('Error en PUT /api/dashboards/:dashboardId:', err.message);
      return res.status(500).json({ error: 'Error interno del servidor' });
    }
  }
);
...
app.delete(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error('Error en DELETE /api/dashboards/:dashboardId:', err.message);
      return res.status(500).json({ error: 'Error interno del servidor' });
    }
  }
);
